...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  #How does .select{} work on an array?
  ...
  # ------------------------------------------------------------------
  # Question: how do $1,$2 get assigned?
  # Question: what does the 1 argument in the expresion do "hey"[/he/,1]
  ...
  # Question: How does the { $1[0, 1] tie in.
