...
class AboutSymbols < EdgeCase::Koan
  ...
  # THINK ABOUT IT:
  #
  # Question: Why do we convert the list of symbols to strings and then compare
  ...
  #Questions: What does ==/eql/equal check for? 
  ...
  #Questions: What does respond_to mean?
  ...
  # THINK ABOUT IT:
  #
  # Questions: Why is it not a good idea to dynamically create a lot of symbols?
end
